...
(defn -main [& _]
  (let [db (store/seed-db)
    ...
    (println "== jurisdiction/assess eng-4 (sets up sam-uei-unverified) ==")
    ...
    (println "== filing/submit eng-4 (sam-uei-unverified -> HARD hold) ==")
    (println (exec-op actor "t9" {:op :filing/submit :subject "eng-4"} operator))

    (println "== jurisdiction/assess eng-5 (sets up ein-unverified) ==")
    ...
    (println "== filing/submit eng-5 (ein-unverified -> HARD hold) ==")
