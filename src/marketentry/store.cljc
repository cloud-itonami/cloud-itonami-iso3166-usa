(ns marketentry.store
  "SSoT for the United States market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Federal Systems LLC" :portal "SAM.gov"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-sam-uei? true :has-sam-uei? true
             :requires-ein? true :ein-verified? true
             :drafted? false :submitted? false
             :jurisdiction "USA" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "SAM.gov"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-sam-uei? true :has-sam-uei? true
             :requires-ein? true :ein-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Defense LLC" :portal "SAM.gov"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "USA" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export Inc" :portal "SAM.gov"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-sam-uei? true :has-sam-uei? false
             :requires-ein? true :ein-verified? true
             :drafted? false :submitted? false
             :jurisdiction "USA" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics Inc" :portal "SAM.gov"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-sam-uei? true :has-sam-uei? true
             :requires-ein? true :ein-verified? false
             :drafted? false :submitted? false
             :jurisdiction "USA" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech Inc" :portal "SAM.gov"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-sam-uei? has-sam-uei?
                               requires-ein? ein-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-sam-uei?)  (assoc :engagement/requires-sam-uei? requires-sam-uei?)
    (some? has-sam-uei?)       (assoc :engagement/has-sam-uei? has-sam-uei?)
    (some? requires-ein?)    (assoc :engagement/requires-ein? requires-ein?)
    (some? ein-verified?)    (assoc :engagement/ein-verified? ein-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-sam-uei? :engagement/has-sam-uei?
   :engagement/requires-ein? :engagement/ein-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-sam-uei? (boolean (:engagement/requires-sam-uei? m))
     :has-sam-uei? (boolean (:engagement/has-sam-uei? m))
     :requires-ein? (boolean (:engagement/requires-ein? m))
     :ein-verified? (boolean (:engagement/ein-verified? m))
